...
public:
  ...
  bool GetMaliciousEnable () const
  {
    ...
    void SetMitigationEnable (bool f) 
  { 
        m_mitigation = f; 
  }                             //by alok singh 'Department of Electronics and Communication, University of Allahabad'                 
  bool GetMitigationEnable () const
  {
        return m_mitigation;
  }                              //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
...
private:
  ...
  bool m_malicious;  //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
  
  bool m_mitigation;  //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
