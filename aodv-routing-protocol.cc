...
RoutingProtocol::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::aodv::RoutingProtocol")
    ...
    .AddAttribute ("IsMalicious", "Is the node malicious",
                   ...
                   MakeBooleanChecker ())  //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
     .AddAttribute ("IsMaliciousMitigation", "Is the node malicious",
                   BooleanValue (false),
                   MakeBooleanAccessor (&RoutingProtocol::SetMitigationEnable,
                                        &RoutingProtocol::GetMitigationEnable),
                   MakeBooleanChecker ())  //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
  ;
  return tid;
}
...
if (m_malicious)
        {
                if(receiver == "10.1.1.5" || receiver == "10.1.1.4")
                {   
                        return;
                }
        }     //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
...
if (m_mitigation)
        {std::cout << "mitigation = " << m_mitigation << std::endl;
                if(receiver == "10.1.1.2" && (src=="10.1.1.4" || src == "10.1.1.5"))
                {   
...
RoutingProtocol::ProcessHello (RrepHeader const & rrepHeader, Ipv4Address receiver )
{
  if (m_mitigation)
        {std::cout << "mitigation = " << m_mitigation << std::endl;
                if(receiver == "10.1.1.2" && (rrepHeader.GetOrigin ()=="10.1.1.4" || rrepHeader.GetOrigin () == "10.1.1.5"))
                {   
  ...
  if (m_malicious && (receiver == "10.1.1.4" || receiver == "10.1.1.5"))
      {
      
    if((rrepHeader.GetDst ()=="10.1.1.4") || (rrepHeader.GetDst ()=="10.1.1.5"))
   {
        return;
   }
   }  //by alok singh 'Department of Electronics and Communication, University of Allahabad'  
